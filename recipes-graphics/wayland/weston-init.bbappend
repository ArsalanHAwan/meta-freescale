...
SRC_URI:append_mx6sl = " file://weston.config"
...
"
INI_UNCOMMENT_ASSIGNMENTS:append_mx7ulp = " \
    use-g2d=1 \
"
INI_UNCOMMENT_ASSIGNMENTS:append_mx8mm = " \
    use-g2d=1 \
"
INI_UNCOMMENT_ASSIGNMENTS:append_mx8mp = " \
    use-g2d=1 \
"
INI_UNCOMMENT_ASSIGNMENTS:append_mx8mq = " \
    gbm-format=argb8888 \
    \\[shell\\] \
    size=1920x1080 \
"
